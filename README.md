...
- **Circulating tumor nucleic acids: biology, release mechanisms, and clinical relevance** — *Molecular Cancer* (2023).
  - Why it matters: Strong foundation for ctDNA/ctRNA origin, release biology, shedding heterogeneity, and clinical relevance.
  - Best for learning: Source biology, release mechanisms, and why tumor shedding is variable across patients and disease states.
...
- **The comings and goings of cell-free DNA: Biological and clinical implications** — *Med* (2026; ePub 2025).
  ...
  - Best for learning: Kinetics, nuclease biology, clearance pathways, tissue-of-origin logic, and why cfDNA behavior constrains assay design.
...
- **Monitoring and Assessment of Circulating Tumor DNA in Cancers Using Ultrarapid Sensitivity as an Innovative Practice** — *Health Science Reports* (2025).
  - Why it matters: Broad overview of ctDNA monitoring and assessment, useful as an additional synthesis layer.
  - Best for learning: Survey-style review of monitoring applications after the foundational methods papers above.
...
- **The impact of preanalytical variables on the analysis of cell-free DNA from blood and urine samples** — *Frontiers in Cell and Developmental Biology* (2024).
  ...
  - Best for learning: Tube choice, processing delay, storage effects, matrix effects, and why pre-analytics dominate downstream reproducibility.
...
- **The Effect of Preanalytical and Physiological Variables on Cell-Free DNA Fragmentation** — *Clinical Chemistry* (2022).
  - Why it matters: Empirical study of how collection tubes, processing time, and host physiology affect fragmentomic readouts.
  - Best for learning: Fragmentation bias, fragment-end effects, batch effects, and why fragmentomics is especially pre-analytically sensitive.
...
- **Liquid biopsies across the cancer care continuum** — *Nature Medicine* (2025).
  ...
  - Best for learning: End-to-end clinical workflow and how different analytes map onto different oncology decisions.
  - Link: https://www.nature.com/articles/s41591-025-04093-9

- **Liquid Biopsy Approaches for Cancer Characterization, Residual Disease Detection, and Therapy Monitoring** — *American Society of Clinical Oncology Educational Book* (2025).
  - Why it matters: Clinically oriented review with strong utility for early-stage learners.
  - Best for learning: Actionable mutation profiling, residual disease detection, therapy monitoring, and trial-linked clinical framing.
...
- **Circulating tumor DNA: a biomarker for oncology drug development in phase I clinical trials?** — *Expert Review of Molecular Diagnostics* (2025).
  ...
  - Best for learning: Phase I trial integration, translational endpoints, response kinetics, and biomarker-readout strategy in first-in-human studies.
  - Link: https://www.tandfonline.com/doi/full/10.1080/14737159.2025.2531065?af=R
...
- **Promises and pitfalls of multi-cancer early detection using liquid biopsy tests** — *Nature Reviews Clinical Oncology* (2025).
  ...
  - Best for learning: Sensitivity-specificity tradeoffs, prevalence effects, false-positive burden, overdiagnosis risk, and implementation barriers.
...
- **Liquid biopsy-based multi-cancer early detection: an exploration road from evidence to implementation** — *Science Bulletin* (2025).
  ...
  - Best for learning: Evidence generation, trial design, endpoint selection, panel composition, and translational implementation planning.
...
- **Genomic and fragmentomic landscapes of cell-free DNA for early cancer detection** — *Nature Reviews Cancer* (2025).
  - Why it matters: High-value synthesis of mutation-derived and fragmentation-derived signals for early cancer detection.
  - Best for learning: How genomic and fragmentomic features complement each other in low-tumor-fraction settings.
...
- **Cell-free DNA fragmentomics in cancer** — *Cancer Cell* (2025). 
  ...
  - Best for learning: Fragment length spectra, end motifs, nucleosome footprints, and AI-enabled signal extraction.
